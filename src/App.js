  ...
  return (
    ...
    >
      ...
      <Page background={{ color: "dark-1" }} fill>
        ...
        <div className="md-visible">MEDIUM</div>
        <div className="lg-visible">LARGE</div>
        <Header
          align="center"
          direction="row"
          flex="grow"
...
const AddElec = () => {
  ...
  const handleChange = (event) => {
    const airconNo = event.target.name;
    const airconNumber = event.target.value;
    const airconPower = event.target.name;
    const airconPowerV = event.target.value;
    setformInfo((formInfo) => ({
      ...formInfo,
      [airconNo]: airconNumber,
      [airconPower]: airconPowerV,
    }));
  };
